...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $appointmentId = $_POST['acceptAppointmentId'];
...
function sendEmail($appointmentId, $conn) {
    ...
    try {
        ...
        if ($appointmentResult) {
            ...
            $mail->Body = 'The appointment has been accepted successfully.';
